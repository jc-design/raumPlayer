    ...
    public sealed partial class Shadow : UserControl
    {
        ...
        private void UpdateShadowValues()
        {
            ...
            if (_shadowDirectionalVisual != null)
            {
                ...
                _shadowDirectional.Opacity = o * 0.5f;
                _shadowDirectional.Offset = new Vector3(0, 4, 0);
                _shadowDirectional.Color = Color;
            }
            if (_shadowAmbientVisual != null)
            {
                _shadowAmbient.BlurRadius = (e * 0.9f);
                _shadowAmbient.Opacity = o * 0.5f;
                _shadowAmbient.Offset = new Vector3(0, 4, 0);
