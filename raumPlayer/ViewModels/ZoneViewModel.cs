...
{
    public class ZoneViewModel : ViewModelBase, Interfaces.IZoneViewModel
    {
        ...
        public int CurrentTrack
        {
            ...
            set { SetProperty(ref currentTrack, value); shellViewModel.RefreshBinding("ActiveZoneViewModel"); }
        }
        ...
        private IElement avTransportURIMetaData;
        public IElement AVTransportURIMetaData
        {
            get { return avTransportURIMetaData; }
            set { SetProperty(ref avTransportURIMetaData, value); }
        }

        private ObservableCollection<IElement> zoneViewModelTracks;
        public ObservableCollection<IElement> ZoneViewModelTracks
        {
