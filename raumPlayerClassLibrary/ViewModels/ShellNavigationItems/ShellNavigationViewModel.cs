...
{
    public class ShellNavigationViewModel : ViewModelBase, IShellNavigationItem
    {
        ...
        public ShellNavigationViewModel(IEventAggregator eventAggregatorInstance, IRaumFeldService raumFeldServiceInstance, IShellViewModel shellViewModel, string label, string symbol, string pageIdentifier)
        {
